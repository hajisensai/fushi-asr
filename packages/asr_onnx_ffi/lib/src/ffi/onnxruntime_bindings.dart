// 机器生成，勿手改。重新生成见 packages/asr_onnx_ffi/ffigen.yaml。
...
/// ONNX Runtime 1.22.0 C API（MIT，头文件 vendored 在 third_party/）
...
final class OrtApi extends ffi.Struct {
  ...
  external ffi.Pointer<
      ffi.NativeFunction<
          OrtStatusPtr Function(ffi.Pointer<OrtSessionOptions> options,
              ffi.Pointer<ffi.WChar> profile_file_prefix)>> EnableProfiling;
  ...
  external ffi.Pointer<
      ffi.NativeFunction<
          OrtStatusPtr Function(
              ...
              ffi.Pointer<ffi.WChar> path)>> RegisterExecutionProviderLibrary;
